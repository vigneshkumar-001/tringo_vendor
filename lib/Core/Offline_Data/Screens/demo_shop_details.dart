...
import 'package:tringo_vendor_new/Presentation/Shops%20Details/Controller/shop_details_notifier.dart';
...
class DemoShopDetails extends StatefulWidget {
  const DemoShopDetails({super.key});

  @override
  State<DemoShopDetails> createState() => _DemoShopDetailsState();
}

class _DemoShopDetailsState extends State<DemoShopDetails> {
  int selectedIndex = 0;
  int selectedWeight = 0;
  final List<String> images = [
    AppImages.krishna_sweets,
