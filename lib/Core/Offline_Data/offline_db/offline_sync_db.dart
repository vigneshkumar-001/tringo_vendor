...
//       },
//       onUpgrade: (d, oldV, newV) async {
//         // ✅ safest for now: ensure tables + index exist
//         await _createAll(d);
//       },
//     );
//   }
...
//     );
//     if (rows.isEmpty) return null;
//     return jsonDecode(rows.first['payloadJson'] as String)
...
//
//         await d.execute('''
//           CREATE INDEX idx_steps_session_stepType
//           ON sync_steps(sessionId, stepType);
//         ''');
//       },
//     );
...
//   }
//
//   /// ✅ Insert if not exists, else update payload (same sessionId + stepType)
//   Future<void> upsertStep({
//     required String sessionId,
//     required SyncStepType type,
//     required Map<String, dynamic> payload,
...
//         'sync_steps',
//         {
//           'status': enumName(SyncStepStatus.pending), // reset to pending
//           'payloadJson': jsonEncode(payload),
//           'errorMessage': null,
//           'updatedAt': now,
//         },
...
//   }
//
//   // ✅ Generic getter for any step payload
//   Future<Map<String, dynamic>?> getStepPayload(
//     String sessionId,
//     SyncStepType type,
//   ) async {
//     return getPayload(sessionId, type);
//   }
//
//   // ✅ Convenience getters (optional)
//   Future<Map<String, dynamic>?> getProductImagesPayload(String sessionId) =>
//       getPayload(sessionId, SyncStepType.productImages);
//
//   Future<Map<String, dynamic>?> getServiceImagesPayload(String sessionId) =>
//       getPayload(sessionId, SyncStepType.serviceImages);
//
//   Future<void> markFailed({
//     required String sessionId,
//     required SyncStepType type,
