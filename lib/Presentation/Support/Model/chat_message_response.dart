...
class ChatMessageResponseData {
  ...
  ChatMessageResponseData({required this.ticket, required this.messageGroups});
  ...
  Map<String, dynamic> toJson() => {
    ...
    'messageGroups': messageGroups.map((e) => e.toJson()).toList(),
  };
}
